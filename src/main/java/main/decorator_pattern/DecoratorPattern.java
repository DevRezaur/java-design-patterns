package main.decorator_pattern;
...
public class DecoratorPattern {
	public static void main(String[] args) {
		CarDecorator carDecorator = new CarDecoratorImpl();
		Map<String, Object> requirements = new HashMap<>();
		requirements.put("brand", "Toyota");
		requirements.put("model", "Hilux");
		requirements.put("color", "Black");

		Car car = new Car();

		WheelDecorator wheelDecorator = new WheelDecorator(carDecorator);
		wheelDecorator.decorate(requirements, car);
